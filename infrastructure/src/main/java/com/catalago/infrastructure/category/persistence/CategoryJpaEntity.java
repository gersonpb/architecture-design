...
public class CategoryJpaEntity {
    ...
    @Column(name = "created_at", nullable = false, columnDefinition = "6")
    private Instant createdAt;
    @Column(name = "updated_at", nullable = false, columnDefinition = "6")
    private Instant updatedAt;
    @Column(name = "deleted_at", columnDefinition = "6")
