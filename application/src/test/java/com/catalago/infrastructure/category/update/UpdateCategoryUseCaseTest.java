...
public class UpdateCategoryUseCaseTest {
    ...
    // 5. Teste atualizando categoria passando ID inválido
    ...
    public void givenAValidCommand_whenCallsUpdateCategory_shouldReturnCategoryId() {
        ...
        Mockito.verify(categoryGateway, times(1)).update( argThat(
            aUpdateCagory ->
                Objects.equals(expectedName, aUpdateCagory.getName())
                    && Objects.equals(expectedDescription, aUpdateCagory.getDescription())
                    && Objects.equals(expectedIsActive, aUpdateCagory.isActive())
                    && Objects.equals(expectedId, aUpdateCagory.getId())
                    && Objects.equals(aCategory.getCreatedAt(), aUpdateCagory.getCreatedAt())
                    && aCategory.getUpdatedAt().isBefore(aUpdateCagory.getUpdatedAt())
                    && Objects.isNull(aUpdateCagory.getDeletedAt())
        ));
        ...
        Mockito.verify(categoryGateway, times(1)).update( argThat(
            aUpdateCagory ->
                Objects.equals(expectedName, aUpdateCagory.getName())
                    ...
                    && Objects.equals(aCategory.getCreatedAt(), aUpdateCagory.getCreatedAt())
                    && aCategory.getUpdatedAt().isBefore(aUpdateCagory.getUpdatedAt())
                    && Objects.nonNull(aUpdateCagory.getDeletedAt())
        ));
    }
